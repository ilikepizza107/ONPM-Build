...
Set menus based on Code Menu Stagelist setting [Bird]
###############################################################
* 20523400 00000001 # If 80523400 is equal to 3
...
string "stageslotec/"                   @ $80550B08 # This address might change and crash
string "stageinfoec/"                   @ $80550B18 # This address might change and crash
* E0000000 80008000

###############################################################
Set menus based on Code Menu Stagelist setting [Bird]
###############################################################
* 20523400 00000002 # If 80523400 is equal to 4
...
string "stageinfobr/"                   @ $80550B18 # This address might change and crash
* E0000000 80008000

###############################################################
Set menus based on Code Menu Stagelist setting [Bird]
###############################################################
* 20523400 00000003 # If 80523400 is equal to 5
string "/menu2/br_menumain.pac"         @ $806FB248
string "br_menumain_en.pac"             @ $817F62BC
string "/menu2/br_selcharacter2.pac"    @ $806FF308
string "br_selcharacter2_en.pac"        @ $817F634D
